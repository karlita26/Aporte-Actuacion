...
class Backend {
  ...
  final _sillas = [
    Silla(
      id: 631,
      nombre: 'Silla roja gamer',
      material: 'Silla comoda metalica ',
      precio: "1000",
      descripcion:
          'Silla gamer',
    ),
     Silla(
      ...
      material: 'Silla para oficina de 4  ',
      precio: "2000",
      descripcion:
          'Silla de oficina',
    ),
  ...
  /// Returns all silla.
    ...
    List<Silla> getSillas() {
    return _sillas;
  }

  /// Marks silla identified by its id as read.
  void markSillaAsRead(int id) {
    final index = _sillas.indexWhere((silla) => silla.id == id);
    _sillas[index].read = true;
  }

  /// Deletes silla identified by its id.
  void deleteSilla(int id) {
    _sillas.removeWhere((silla) => silla.id == id);
  }
